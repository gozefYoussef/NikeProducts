...
const Hero = () => {
  return (
    <section
        id="home"
        className="w-full flex xl:flex-row flex-col items-center justify-center min-h-screen gap-10 max-container"
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        <p className="text-xl font-montserrat text-coral-red">Our Summer Collection</p>
        <h1 className="mt-10 font-palanquin text-8xl leading-[120px] max-sm:text-[72px] max-sm:leading-[82px]">
